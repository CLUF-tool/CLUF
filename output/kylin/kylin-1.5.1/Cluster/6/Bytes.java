...
public class Bytes {
     ...
     * @param length length of data (must be {@link
     * @return the long value
     * @throws IllegalArgumentException if length is not {@link
     ...
     * @param bytes  byte array
     * @param offset offset into array
     * @param length length of int (has to be {@link
     * @return the int value
     * @throws IllegalArgumentException if length is not {@link
     *                                  if there's not enough room in the array at the offset indicated.
     */
    ...
    /**
     * Convert a short value to a byte array of {@link
     *
     * @param val value
     * @return the byte array
     */
     ...
     * @param bytes  byte array
     * @param offset offset into array
     * @param length length, has to be {@link
     * @return the short value
     * @throws IllegalArgumentException if length is not {@link
     ...
     * @return Runs {@link org.apache.hadoop.io.WritableComparator
