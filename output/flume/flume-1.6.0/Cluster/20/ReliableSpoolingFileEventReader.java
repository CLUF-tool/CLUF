 ...
 * read (through {@link EventDeserializer
 * {@link
 * processed.
...
public class ReliableSpoolingFileEventReader implements ReliableEventReader {
   ...
   * If the {@link
   * then returns the oldest file. If the {@link
   * is {@link ConsumeOrder
